export const jobsList = [
  ...
  },
  {
    ...
    jobTitle: 'Dévellopeur Front-end',
    jobDescription:
      'Mise en place d’applications web, native, et évolution de petits projets dont l’objectif principal est d’offrir une aide quotidienne à différents pôles Chanel'
  },

  {
    ...
    jobDescription:
      'Développement d’applications à destination des clients de Paprec, ces dernières doivent permettre la commande et le suivi des prestations proposées par le groupe'
  },

  {
    ...
    jobDescription: 'Intervention sur le projet Tirelire Connectée Monimalz '
  },

  {
    ...
    jobDescription:
      "Reprise et développement d’une application de gestion de devis, support applicatif et TMA de l'intranet"
  },

  {
    ...
    jobTitle: 'Dévellopeur PHP Fullstack',
    jobDescription:
      'Développement et maintenance de sites web vitrine & back-office pour des clients divers '
  }
];
